...
export function DangerSection() {
  ...
  const [deleteResult, deleteAction, deletePending] = useActionState(deleteAccountAction, null)
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between py-3 border-b border-gray-100">
          <div>
            ...
            <p className="text-xs text-gray-500">Download all your streaks as a CSV file.</p>
          </div>
          <a
            href="/api/export"
            download
          ...
          {showDelete ? (
            <div className="rounded-lg bg-red-50 border border-red-200 p-4 space-y-3">
              <p className="text-sm font-medium text-red-800">
                This will permanently delete your account, all streaks, and all history. Type{' '}
