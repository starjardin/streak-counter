...
const OPTIONS: { value: ReminderFrequency; label: string; description: string }[] = [
  { value: 'daily', label: 'Daily', description: 'Every day at 9 AM UTC' },
  { value: 'three_per_week', label: '3× per week', description: 'Monday, Wednesday & Friday' },
...
export function RemindersSection({ current }: Props) {
  const [error, action, pending] = useActionState(saveReminderPreferenceAction, null)
  ...
  return (
    <section className="bg-white rounded-xl border border-gray-200 p-6">
      <h2 className="text-base font-semibold text-gray-900 mb-1">Email reminders</h2>
